    ...
    public void testExtractLoopPath() {
        ...
        */
        if (f1 && oldPath.isValid()) {
            ...
            for (int i = 0; i < oldNodes.size() - 1; i++) {
                int j;
                for (j = 0; j < loopNodes.size(); j++) {
                    if (i + j >= oldNodes.size() || !Objects.equals(loopNodes.get(j), oldNodes.get(i + j))) {
                        break;
                    }
                }
                if (j == loopNodes.size() && Objects.equals(loopNodes.get(0), loopNodes.get(loopNodes.size() - 1))) {
                    isLoop = true;
                    break;
                }
            }
